<?php
/**
 * @package   Social Shares
 * @author    Waterloo Plugins
 * @license   GPL-2.0+
 * @copyright 2014 Waterloo Plugins
 *
 * @wordpress-plugin
...
<p class=description>Alternatively, you can add "?sort_shares=desc" to the end of any URL to sort it by shares.</p>
</td>
</tr>
...
<td><a href="<?php bloginfo('home') ?>/wp-admin/options-general.php?page=social_shares.php&update=true" class="button button-default">Update</a></td>
</tr>
